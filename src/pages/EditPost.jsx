...
export default function EditPost() {
  ...
  useEffect(() => {
    async function carregarPost() {
      ...
      try {
        ...
        setErro("Não foi possível carregar as informações do post para edição.");
      } finally {
        setLoading(false);
      }
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showNotification(`Post "${titulo}" atualizado com sucesso!`, "success");
      navigate(`/post/${id}`);
    } catch (err) {
      console.error("Erro ao atualizar post:", err);
      setErro("Erro ao salvar as alterações do post. Tente novamente.");
    } finally {
      setSalvando(false);
    }
  };
      ...
      <main className="form-page-container">
        <div className="form-card">
          <div className="form-header">
            ...
            <p>Altere os campos abaixo e clique em salvar para atualizar o artigo.</p>
          </div>
