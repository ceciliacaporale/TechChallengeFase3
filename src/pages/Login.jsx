...
export default function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!usuario.trim() || !senha.trim()) {
      setErrorMsg("Preencha todos os campos para acessar.");
      return;
    }
  ...
  const handleQuickLogin = () => {
    login("Prof. Dr. Eduardo Silva", "123456");
    navigate(from, { replace: true });
  };
    ...
    <div className="container">
      <header className="header">
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          <img src={logo} alt="Logo Blog Educacional" className="logoTop" />
      ...
      <main className="content">
        <div className="login-box">
          <div className="login-header">
            ...
            <p>Faça login com suas credenciais para gerenciar a plataforma.</p>
          </div>

          {stateMessage && (
            <div className="login-alert warning">⚠️ {stateMessage}</div>
          )}
